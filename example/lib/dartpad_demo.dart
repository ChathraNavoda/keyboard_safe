...
//       appBar: AppBar(
//         title: const Text('Animation Customization'),
//         backgroundColor: const Color.fromARGB(255, 1, 70, 124),
//         foregroundColor: Colors.white,
//         elevation: 0,
//       ),
//       body: Container(
...
//             end: Alignment.bottomRight,
//             colors: [
//               Color.fromARGB(255, 1, 70, 124), // Flutter blue dark
//               Color.fromARGB(255, 25, 118, 210), // Flutter blue medium
//               Color.fromARGB(255, 66, 165, 245), // Flutter blue light
//             ],
//           ),
//         ),
//         child: KeyboardSafe(
...
//       theme: ThemeData(
//         colorScheme: ColorScheme.fromSeed(
//           seedColor: const Color.fromARGB(255, 1, 70, 124),
//           brightness: Brightness.light,
//         ),
//         useMaterial3: true,
//         fontFamily: 'SF Pro Display',
...
//         labelText: label,
//         hintText: hintText,
//         prefixIcon: Icon(icon, color: const Color.fromARGB(255, 1, 70, 124)),
//         border: OutlineInputBorder(
//           borderRadius: BorderRadius.circular(16),
//           borderSide: BorderSide.none,
//         ),
...
//         ),
//         floatingLabelStyle: const TextStyle(
//           color: Color.fromARGB(255, 1, 70, 124),
//           fontWeight: FontWeight.w600,
//         ),
//         contentPadding: const EdgeInsets.all(20),
//       ),
...
//           SliderTheme(
//             data: SliderTheme.of(context).copyWith(
//               activeTrackColor: const Color.fromARGB(255, 1, 70, 124),
//               inactiveTrackColor: const Color(0xFFE2E8F0),
//               thumbColor: const Color.fromARGB(255, 1, 70, 124),
//               overlayColor:
//                   const Color.fromARGB(255, 1, 70, 124).withOpacity(0.2),
//             ),
//             child: Slider(
//               value: _experience,
//               min: 0,
...
//           value: _agreeToTerms,
//           onChanged: (value) => setState(() => _agreeToTerms = value ?? false),
//           activeColor: const Color.fromARGB(255, 1, 70, 124),
//           controlAffinity: ListTileControlAffinity.leading,
//           contentPadding: EdgeInsets.zero,
//         ),
//         CheckboxListTile(
...
//                     boxShadow: [
//                       BoxShadow(
//                         color: const Color.fromARGB(255, 1, 70, 124)
//                             .withOpacity(0.3),
//                         blurRadius: 8,
//                         offset: const Offset(0, 2),
//                       ),
